...
namespace Tender.Products
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.Configure<ProductDatabaseSettings>(Configuration.GetSection("ProductDatabaseSettings"));
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "Tender.Products", Version = "v1" });
            });
        }
